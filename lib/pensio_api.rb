...
require 'pensio_api/card_wallet'
...
require 'pensio_api/responses/card_wallet_session'
require 'pensio_api/responses/card_wallet_authorize'
require 'pensio_api/responses/checkout_session'
